...
LOCAL_SRC_FILES := vendor/etc/fstab.elbe
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.elbe
LOCAL_SRC_FILES := vendor/etc/init/init.elbe.rc
LOCAL_MODULE_TAGS := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.elbe.pwr
LOCAL_SRC_FILES := vendor/etc/init/init.elbe.pwr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .rc
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_ETC)/init
